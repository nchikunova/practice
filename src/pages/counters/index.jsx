...
const Counters = () => {
  ...
  const addCounter = () => setCounters(prevState => [
...prevState,
    {
      id: Date.now(),
      value: 0,
  ...
  const handleIncrement = (id) => setCounters(prevState =>
  ...
  const handleDeleteCounter = (id) => setCounters((prevState) => prevState.filter((counter) => counter.id !== id));
